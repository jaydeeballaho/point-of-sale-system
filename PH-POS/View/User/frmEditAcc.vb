Public Class frmEditAcc

    Public col As Accounts
    ...
    Private Sub Add_Account_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtName.Text = col.FirstName
        txtUserName.Text = col.UserName
        txtPw.Text = col.Password
        cboType.SelectedIndex = cboType.FindString(col.Position)
    End Sub
